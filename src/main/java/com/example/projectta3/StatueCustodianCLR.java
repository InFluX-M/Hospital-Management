...
public class StatueCustodianCLR implements Initializable {
    ...
    void GetPaid(MouseEvent event) {
        Main.myHospital.getCustodianManager().getCustodian().registerGetPaid();
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        MonthlyPaid monthlyPaid = Main.myHospital.getCustodianManager().getCustodian().getPaid();
        ...
        ObservableList<MyDate> myDates = FXCollections.observableArrayList(
                Main.myHospital.getCustodianManager().getCustodian().getBusinessDates()
        );

...
public class StatueEmployeeCLR implements Initializable {
    ...
    void GetPaid(MouseEvent event) {
        Main.myHospital.getSecretaryManager().getSecretaries().
                get(Main.myHospital.getSecretaryManager().getSecretaryIndex()).registerGetPaid();
    }
    ...
    @FXML
    void exit(MouseEvent event) {System.exit(1);}

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {

        MonthlyPaid monthlyPaid = Main.myHospital.getSecretaryManager().getSecretaries().
                get(Main.myHospital.getSecretaryManager().getSecretaryIndex()).getPaid();
        ...
        ObservableList<MyDate> myDates = FXCollections.observableArrayList(
                Main.myHospital.getSecretaryManager().getSecretaries()
                        .get(Main.myHospital.getSecretaryManager().getSecretaryIndex()).getBusinessDates()
        );
